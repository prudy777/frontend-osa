...
const Dashboard = () => {
  ...
  useEffect(() => {
    const fetchData = async () => {
      try {
        const salesResponse = await axios.get('https://frontend-osa.vercel.app/api/sales');
        const revenueResponse = await axios.get('https://frontend-osa.vercel.app/api/revenue');
        const customersResponse = await axios.get('https://frontend-osa.vercel.app/api/customers');
        const reportsResponse = await axios.get('https://frontend-osa.vercel.app/api/reports');
        const recentSalesResponse = await axios.get('https://frontend-osa.vercel.app/api/recent-sales');
        const topSellingResponse = await axios.get('https://frontend-osa.vercel.app/api/top-selling');
        const recentActivityResponse = await axios.get('https://frontend-osa.vercel.app/api/recent-activity');
