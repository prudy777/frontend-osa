...
const Register = ({ onRegisterSuccess }) => {
  ...
  return (
    ...
    <option value="malariaParasiteRapidAg">Malaria Parasite (Rapid Ag)</option>
    ...
    <option value="occultBloodTestStool">Occult blood test (stool)</option>
    ...
    <option value="wbcCount">WBC Count (Total and Differential)</option>
    <option value="bloodFilmExamination">Blood Film Examination/ Comment</option>
    <option value="genotype">Genotype</option>
    <option value="bloodGroupRhesusGrouping">Blood Group and Rhesus Grouping</option>
    <option value="esr">ESR</option>
    <option value="sickleCellTest">Sickle cell Test</option>
    <option value="directIndirectCoombsTest">Direct & Indirect Coomb's Test</option>
    ...
    <option value="hepatitisBCScreening">Hepatitis B & C Screening</option>
    <option value="hepatitisBPanel">Hepatitis B panel</option>
    <option value="hepatitisBDNAViralLoad">Hepatitis B DNA Viral Load</option>
    ...
    <option value="herpesSimplexVirus">Herpes Simplex Virus (HSV)</option>
    <option value="serumTuberculosis">Serum Tuberculosis (TB)</option>
    <option value="thyroidFunctionTest">Thyroid Function Test (T3T4 & TSH)</option>
    ...
    <option value="ca199">CA-19-9 (G.I.T Pancreatic cancer marker)</option>
    <option value="cea">CEA (GIT Lung Breast)</option>
    <option value="antimullerianHormone">Antimullerian Hormone (Auto-immune disease)</option>
    ...
    <option value="hormonalProfileMale">Hormonal Profile (Male)</option>
    <option value="hormonalProfileFemale">Hormonal Profile (Female)</option>
    <option value="fastingRandomBloodSugarTest">Fasting/Random Blood Sugar test</option>
    ...
    <option value="kidneyFunctionTest">Kidney Function Test (E/U/Cr)</option>
    <option value="creatinineClearance">Creatinine clearance</option>
    <option value="calcium">Calcium</option>
    <option value="phosphorous">Phosphorous</option>
    <option value="magnesium">Magnesium</option>
    <option value="liverFunctionTest">Liver Function Test (LFT)</option>
    <option value="totalDirectBilirubinTest">Total & Direct Bilirubin test</option>
    ...
    <option value="lipidProfile">Lipid Profile (Cholesterol Trig HDL LDL)</option>
    ...
    <option value="infectionScreeningTests">Infection Screening tests</option>
    <option value="premaritalCounsellingTesting">Pre-marital counselling and Testing</option>
    <option value="preemploymentScreening">Pre-employment screening</option>
    <option value="domesticStaffScreening">Domestic staff screening</option>
    <option value="infertilityScreening">Infertility screening</option>
    <option value="comprehensiveHealthAssessmentTests">Comprehensive health assessment tests</option>
